...
export const Icon = ({ name, size = 18 }) => {
  ...
  const paths = {
    ...
    search:    <><circle cx="11" cy="11" r="6" /><path d="m16 16 4 4" /><path className="s-handleleaf" d="M18.7 18.5 C18.4 16.7 19.4 15.4 21.1 15.3 C21.4 17.1 20.4 18.4 18.7 18.5 Z" /><g className="s-bloom"><circle cx="11" cy="9.5" r="1.2" /><circle cx="9.45" cy="10.6" r="1.2" /><circle cx="12.55" cy="10.6" r="1.2" /><circle cx="10.05" cy="12.45" r="1.2" /><circle cx="11.95" cy="12.45" r="1.2" /></g></>,
