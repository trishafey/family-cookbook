...
export const Icon = ({ name, size = 16 }) => {
  const paths = {
    ...
    chef:      <><path d="M7.5 8 C 5.3 8, 4.3 5.5, 6 4 C 5.7 2.2, 8 1.8, 9.2 3.3 C 9.7 1.9, 14.3 1.9, 14.8 3.3 C 16 1.8, 18.3 2.2, 18 4 C 19.7 5.5, 18.7 8, 16.5 8 Z" /><path d="M8 8 V 9.5 H 16 V 8" /><circle cx="12" cy="13.5" r="3.2" /><path d="M5 21 C 5 17.5, 8 15.8, 12 15.8 C 16 15.8, 19 17.5, 19 21" /></>,
